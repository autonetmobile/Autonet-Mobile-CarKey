...
var AutonetApplication = {
  ...
  httpErrorMessage: "Unable to connect to Autonet. Retry?",
  invalidPasswordResponse: "Invalid Id",
  invalidPasswordMessage: "Invalid Email or Password, please try again",
  ...
  mapLocation : function(coordinates, name){
    ...
    if (typeof(device) != "undefined" && (device.platform == "iPhone" || device.platform == "iPad")) {
      window.location = "maps:q=" + encodeURIComponent(coordinates + "(" + name + ")");
    } else {
...
var EULAText = "Welcome to Autonet Mobile, Inc. (“us” or “we” or “Autonet”). This Agreement (“Agreement”) sets forth the terms and conditions among you and us that govern the Service. It replaces any earlier agreements between you and us regarding the Service and applies to all services you receive from us and any applications we make available for mobile devices.  We refer to the applications we make available for mobile devices as the “Applications” and all the services and provided to you by us as the “Service.”<br/>\
...
MOPAR CONNECT SOFTWARE.  The Equipment includes software that we may need or want to update from time to time.  You agree that we may do this remotely without notifying you first. You acknowledge that such changes may affect or erase data you’ve stored on the Equipment in your Car and we aren’t responsible for any lost data.   We retain ownership of the Software and you do not acquire any rights to the Software, except that we grant you a non-exclusive license to use the Software solely as included with the Equipment for your personal, non-commercial use. Your Car systems also involve software that your car maker may need to change from time to time.  You agree that we may assist them to do this remotely without your consent.  <br/>\
MOPAR CONNECT APPLICATIONS.  Subject to the terms of this Agreement, we grant you a non-transferable, non-exclusive, license to download, install and use one copy of the Application on a mobile device that you own or control for your personal, non-commercial use.  We retain ownership of the Application and you do not acquire any rights to the Application except as set forth above.<br/>\
 RESTRICTIONS ON YOUR USE OF MOPAR CONNECT SOFTWARE AND MOPAR CONNECT APPLICATIONS.  Your right to use the Software and Application under this Agreement are subject to the following restrictions: (a) you shall not license, sell, rent, lease, transfer, assign, distribute, host, or otherwise commercially exploit the Software or Application; (b) you shall not modify, translate, adapt, merge, make derivative works of, disassemble, decompile, reverse compile or reverse engineer any part of the Software or Application, except to the extent the foregoing restrictions are expressly prohibited by applicable law; (c) you shall not access the Software or Application in order to build a similar or competitive product or service; (d) except as expressly stated herein, no part of the Software or Application may be copied, reproduced, distributed, republished, downloaded, displayed, posted or transmitted in any form or by any means, or (e) you shall not remove or destroy any copyright notices or other proprietary markings contained on or in the Application.   Any future release, update, or other addition to functionality of the Software or Application shall be subject to the terms of this Agreement.<br/>\
...
<br/>\
YOU DON’T HAVE ANY RIGHTS IN YOUR NUMBERS.  You don’t have any rights to any identifying number (such as a Personal Identification Number) that you use with the Service or to any wireless phone number (such as the right to choose a number), except for any right you may have to port it under applicable law.  We reserve the right to change or reassign them, in which case we will notify you if we decide to change or reassign them.  A wireless phone number we assign for Hands-Free Calling may not be in your local area code.  <br/>\
BUYING, LEASING OR SELLING A CAR EQUIPPED WITH MOPAR CONNECT.  If you buy or lease a pre-owned Car equipped with the Service, you promise to contact us promptly to create an account.  If you do not contact us, we may continue to send vehicle diagnostic reports or other information about the Car or the account to the billing or email address currently on file with us.  Further, you promise to notify us if you sell your Car or end its lease.  If you sell or transfer your Car and don’t notify us, you’ll remain responsible for all fees and charges for the Service.  You are responsible for erasing all data that you store on your Equipment before you sell or transfer your Car.  We are not responsible for any privacy related damages you may suffer if you fail to notify us of your purchase, lease or sale of a Car or if you fail to erase the data you stored on the Equipment before selling or transferring your Car.<br/>\
...
<br/>\
THIS IS THE ENTIRE AGREEMENT.  This Agreement is the entire agreement between you and us. It supersedes all other agreements or representations, oral or written, between us, past or present, and may not be amended except in a writing signed by us.  Amendments of which we give notice and post to the website at www.autonetmobile.com will be deemed a writing signed by us.   If any part of this Agreement is considered invalid by a court or arbitrator, the rest of it will remain enforceable, except that if a court or arbitrator refuses to enforce the waiver of class arbitration in the arbitration clause for any particular dispute between us, the entire arbitration clause will be void and unenforceable as to that particular dispute. Even after this Agreement has ended, its provisions will govern any disputes arising out of or relating to it (unless it’s been replaced by a new agreement between us). It will also be binding on your heirs and successors and on our successors. No waiver of any part of this Agreement, or of any breach of it, in any one instance will require us to waive any other instance or breach. IN SOME CIRCUMSTANCES WE MIGHT DECIDE TO PROVIDE YOU SERVICE VOLUNTARILY EVEN IF YOU WOULDN’T OTHERWISE QUALIFY. THIS WON’T BE A WAIVER OR REQUIRE US TO DO SO AGAIN. YOU AGREE WE WON’T BE LIABLE FOR ANYTHING RESULTING FROM OUR PROVISION OF SUCH SERVICE.<br/>\
Apple App Store Additional Terms and Conditions.  The following additional terms and conditions apply to you if you are using a Application from the Apple App Store.  To the extent the other terms and conditions of this Agreement are less restrictive than, or otherwise conflict with, the terms and conditions of this Section 38, the more restrictive or conflicting terms and conditions in this Section 38 apply, but solely with respect to Applications from the Apple App Store.<br/>\
Acknowledgement: You and we acknowledge that this Agreement is concluded between Autonet and you only, and not with Apple, and Autonet, not Apple, is solely responsible for the Application and the content thereof.  To the extent this Agreement provides for usage rules for the Application that are less restrictive than the Usage Rules set forth for the Application in, or otherwise is in conflict with, the App Store Terms of Service, the more restrictive or conflicting Apple term applies.<br/>\
Scope of License: The license granted to you for the Application is limited to a non-transferable license to use the Application on an iOS Product that you own or control and as permitted by the Usage Rules set forth in the App Store Terms of Service.<br/>\
Maintenance and Support: We are solely responsible for providing any maintenance and support services with respect to the Application, as specified in this Agreement (if any), or as required under applicable law. You and we acknowledge that Apple has no obligation whatsoever to furnish any maintenance and support services with respect to the Application.<br/>\
...
Developer Name and Address: Our contact information for any end-user questions, complaints or claims with respect to the Application is set forth in Section 39.<br/>\
Third Party Terms of Agreement: You must comply with applicable third party terms of agreement when using the Application.<br/>\
