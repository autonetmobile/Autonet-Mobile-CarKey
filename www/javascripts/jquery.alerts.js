...
(function($) {
	...
	$.alerts = {
		...
		verticalOffsetPercent: -0.15,       // Percent as a decimal to offset the dialog. verticalOffset no longer used.
		...
		_show: function(title, msg, value, type, callback) {
			...
			$("#popup_message").html("<div>" + $("#popup_message").text().replace(/\n/g, '<br />') + "</div>");
			...
			// Make scrollable
			setTimeout(function () {
					myScroll = new iScroll('popup_message', {
									useTransform: true,
      ...
      top += ($(window).height() * $.alerts.verticalOffsetPercent);
